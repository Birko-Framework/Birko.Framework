...
namespace Birko.Models.Users.ViewModels
{
    public class UserProfile : Birko.Data.ViewModels.LogViewModel
    {
        ...
        {
            if (new[] { FirstNameProperty, LastNameProperty, DisplayNameProperty, PhoneProperty,
                        AvatarUrlProperty, LocaleProperty, TimeZoneProperty, DateOfBirthProperty, BioProperty }.Contains(e.PropertyName))
            {
