...
namespace Birko.Data.XML.Stores
{
        ...
        where T : Models.AbstractModel
    {
        ...
        /// </remarks>
        /// <remarks>
        /// Declared <c>null!</c> here while the async family declares it <c>Settings?</c>, so the
        /// identical hazard produces a warning on one twin and nothing on the other. That is why this
        /// guard exists on both: the sync store was never safer, only quieter.
        /// </remarks>
