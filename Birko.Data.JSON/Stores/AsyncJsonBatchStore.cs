...
{
    /// <summary>
    /// Async JSON store that splits items into batch files (multiple items per file).
    /// </summary>
    /// <typeparam name="T">The type of entity, must inherit from <see cref="Models.AbstractModel"/>.</typeparam>
    public class AsyncJsonBatchStore<T> : AsyncJsonSeparateStore<T>, ISettingsStore<BatchSettings>
        where T : Models.AbstractModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AsyncJsonBatchStore class.
        /// </summary>
        public AsyncJsonBatchStore() : base()
        {
        }
