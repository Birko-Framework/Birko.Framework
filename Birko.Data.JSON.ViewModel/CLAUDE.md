...
### Repositories
- `JsonRepository<TViewModel, TModel>` - Sync bulk ViewModel repository with store validation
- `AsyncJsonRepository<TViewModel, TModel>` - Async bulk ViewModel repository
