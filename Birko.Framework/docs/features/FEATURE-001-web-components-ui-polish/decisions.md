...
| D7 | Work tracked directly on the epic, outside any story | approved | Backfilled: these tasks exist and are tracked, so the scope decision was taken. | 2026-05-28 | ai | [[TASK-053]], [[TASK-486]], [[TASK-488]], [[TASK-489]], [[TASK-490]], [[TASK-494]], [[TASK-495]], [[TASK-496]] |
...
- 2026-09-25 — D7 decomposed → [[TASK-488]] (`b-select` ignored `creatable`), with its follow-ups [[TASK-489]] (combobox ARIA + arrow keys) and [[TASK-490]] (a `creatable` multi-select in `b-form` is a no-op without page code).
- 2026-09-26 — D7 gains [[TASK-494]] (labelled b-* controls had no accessible name, found during TASK-488's screen-reader step) and its out-of-scope verdict [[TASK-495]] (file upload and date range drop the field label).
- 2026-09-26 — D7 gains [[TASK-496]] (picker inputs announce no popup; the b-select clear button is unnamed), found during the owner's screen-reader passes that closed [[TASK-489]] and [[TASK-495]].
