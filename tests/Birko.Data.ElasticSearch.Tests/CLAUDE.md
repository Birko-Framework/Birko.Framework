...
- NEST / Elasticsearch.Net - Elasticsearch client libraries

## Known Issues
- `ParseAnyExpression` test fails - pre-existing issue with nested Any() expression parsing

## Running Tests
```bash
dotnet test Birko.Data.ElasticSearch.Tests.csproj
```
