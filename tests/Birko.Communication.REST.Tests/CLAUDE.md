# Birko.Communication.REST.Tests
...
## Test Structure
- `RestClientTests.cs` - REST client tests

## Dependencies
- Birko.Communication.REST (via .projitems) - REST client implementation
- Birko.Communication (via .projitems) - communication abstractions

## Running Tests
```bash
dotnet test Birko.Communication.REST.Tests.csproj
```
