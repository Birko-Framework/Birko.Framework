...
namespace Birko.Workflow.MongoDB.Tests;

/// <summary>
/// CR-M271: Birko.Workflow.MongoDB had no test project. Covers the backend-independent model round-trip
/// (FromInstance / ToInstance / UpdateFromInstance) — Data + History survive, CreatedAt is preserved and
/// UpdatedAt bumped on update, empty history, and Status enum casting.
/// </summary>
public class MongoWorkflowInstanceModelTests
{
    ...
    public void FromInstance_Then_ToInstance_RoundTrips()
    {
        ...
        var model = MongoWorkflowInstanceModel.FromInstance("OrderWorkflow", original);
    ...
    public void FromInstance_WithInjectedSerializer_OverridesFormat()
    {
        ...
        var model = MongoWorkflowInstanceModel.FromInstance("W", CreateTestInstance(), pascal);
